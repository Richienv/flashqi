...
export default function FinalPrepPage() {
  return (
    <div className="h-screen min-h-screen flex items-center justify-center bg-neutral-900 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 w-[36vmin] h-[36vmin] rounded-full bg-white mix-blend-overlay pointer-events-none" style={{filter: 'blur(2vmin)', opacity: 0.10, transform: 'translate(-42%, -49%) scale(1)'}}></div>
